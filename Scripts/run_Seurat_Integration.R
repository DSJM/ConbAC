...
run_Seurat_Integration<-function(DataPath,LabelsPath,CV_RDataPath,OutputDir,GeneOrderPath = NULL,NumGenes = NULL){
  "
  run Seurat
...
if (args[6] == "0") {
  run_Seurat_Integration(args[1], args[2], args[3], args[4])
} else {
  run_Seurat_Integration(args[1], args[2], args[3], args[4], args[5], as.numeric(args[6]))
}